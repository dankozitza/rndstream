# d206dd1587109eb7cf79788999fd78ba
# Generated with vfnmkmc by the mc program.
PREFIX=/usr/local
CFLAGS=-O$(O)  -std=c++11           
O=2
LFLAGS= -l jsoncpp
OBJS=objs/jconfig.o objs/commands.o objs/rndstream.o objs/options.o objs/radix.o objs/strings.o objs/doubles.o objs/vectors.o objs/utils.o objs/json_utils.o objs/pcre_utils.o objs/rand_utils.o objs/system.o
