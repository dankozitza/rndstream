# d8bc1d3113dda51a01035bafa45b62ea
# Generated with vfnmkmc by the mc program.
PREFIX=/usr/local
CFLAGS=-O$(O) 
O=2
LFLAGS= -l jsoncpp
OBJS=objs/commands.o objs/jconfig.o objs/options.o objs/rndstream.o objs/radix.o objs/pcre_utils.o objs/rand_utils.o objs/json_utils.o objs/strings.o objs/system.o objs/vectors.o objs/utils.o objs/doubles.o
